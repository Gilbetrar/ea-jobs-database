---
job_id: anthropic--ai-security-fellow--2026-01
source_url: https://job-boards.greenhouse.io/anthropic/jobs/5030244008
...
London, UK; Ontario, CAN; Remote-Friendly, United States; San Francisco, CAApply
...
**[Apply using this link](https://bit.ly/afpsecurity).**** We’re accepting applications on a rolling basis for cohorts starting in July 2026 and beyond. Applications for the May 2026 cohort are now closed.**
 
# **AI Security at Anthropic**
 

We believe we are at an inflection point for AI’s impact on cybersecurity. Models are now useful for cybersecurity tasks in practice: for example, Claude can now [outperform human teams](https://red.anthropic.com/2025/cyber-competitions/) in some cybersecurity competitions and help us discover [vulnerabilities in our own code](https://claude.com/blog/automate-security-reviews-with-claude-code). 
...
Applications and interviews are managed by [Constellation](https://www.constellation.org/), our official recruiting partner for this program. Constellation also runs the Berkeley workspace that hosts fellows. Clicking "Apply here" will redirect you to Constellation's application portal. You can expect to receive emails from Constellation with application updates.
 
# [Apply here](https://bit.ly/afpsecurity)
 

**Note: We are running the [Safety](https://job-boards.greenhouse.io/anthropic/jobs/5023394008) and [Security](https://job-boards.greenhouse.io/anthropic/jobs/5030244008) programs in partnership with each other, please only apply to the one that best matches your interests and background.**
