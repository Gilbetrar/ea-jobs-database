...
- Conduct academic research related to AI in science and the societal impact of AI
- Collect and analyze project data; track and report on key research metrics
...
- Contribute to grant proposals and other academic writing
- Collaborate closely with project leads Ana Trisovic and Neil Thompson

## Qualifications & Skills

Minimum Required Education and Experience

- Bachelor’s degree (BA/BS) in Computer Science, Data Science, or a related field
- Strong data analysis background, including statistical or econometric training
- Proficiency in at least one modern programming language (e.g., Python, R)
- Excellent written and verbal communication skills in English
- Strong organizational abilities and a collaborative working style

‍

Preferred Education and Experience

- Master’s degree (MA/MS) in Computer Science or a related field
- Expertise in computing and artificial intelligence
- Prior experience with academic research or research paper writing

‍

Additional Information

- One-year term appointment, renewable based on grant funding
- Primary work location: on-site at MIT FutureTech (Cambridge, MA)
...
- The AI Frontier: Transformative Role of Foundation Models Across Scientific Disciplines
- LLMs in Citation Intent Classification: Progress, Precision, and Reproducibility Challenges
- [Mapping the Impact of Foundation Models on the UN Sustainable Development Goals](https://arxiv.org/abs/2508.21031)
- [The AI Risk Repository: A Comprehensive Meta-Review, Database, and Taxonomy of Risks from Artificial Intelligence](https://academic.oup.com/pnasnexus/article/4/5/pgaf138/8124449) 
...
- [How Fast Do Algorithms Improve? ](https://drive.google.com/file/d/1Pl8weuwsdM5gJzuhiz2mTGeG3YXtsmrJ/view?usp=drivesdk)
...
Please use this [Computer Science focus ](https://mitfuturetech.atlassian.net/jira/core/form/a35da49a-3ed9-4722-8eda-2258b30bcc29)to register interest in this role or to submit a general expression of interest.
